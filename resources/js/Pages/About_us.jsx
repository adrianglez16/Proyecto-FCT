            ...
            <div class="container py-5">
                <div class="row h-100 align-items-center py-5">
                    <div class="col-lg-6 d-none d-lg-block">
                        <img src='https://bootstrapious.com/i/snippets/sn-about/illus.png' alt=" avatar" className="img-fluid" />
                    </div>
                    <div class="col-lg-6">
                        <h1 class="display-4">Sobre Nosotros</h1>
                        <p class="lead text-muted mb-0">Pagina creada con el objetivo de cumplir los requisitos de los conocimientos basicos en DAW. Idea original de Javier.</p>
                    </div>
                </div>
            </div>
        </div>
